...
- A purchase flow that gates the three paid lessons behind login + ownership, with a QR bank-transfer payment screen (demo mode — clicking "confirm" unlocks the course immediately, since there's no backend to verify a real transfer yet).
