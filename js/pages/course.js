/* ==========================================================================
   HocLab — Course detail page (courses/course.html?id=...)
   ========================================================================== */
(function (window, document) {
  ...
  function render() {
    ...
    if (!root) return;
    if (!course) { notFound(root); document.title = 'Không tìm thấy khoá học · HocLab'; return; }

    document.title = course.title + ' · HocLab';
