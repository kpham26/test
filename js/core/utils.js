...
(function (window) {
  ...
  var Utils = {
    ...
    /** Accepts Vietnamese mobile/landline formats: optional +84/84/0 prefix,
     *  9-10 digits, optional spaces/dots/dashes as separators (e.g.
     *  "0912345678", "+84 912 345 678", "0912.345.678"). */
